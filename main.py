...
# --- 3. Generate Summary (Gemini 2.5 Flash) ---
def generate_summary(tweets_text):
    ...
    2. Use your **Google Search Tool** to verify facts if tweets are vague.
...
def markdown_to_html(text):
    ...
    <head>
        <style>
            ...
            h2.title {{ color: #0056b3; text-align: center; border-bottom: 2px solid #eee; padding-bottom: 10px; font-size: 24px; margin-top: 0; }}
            h3 {{ font-size: 18px; color: #34495e; margin-top: 25px; border-bottom: 1px solid #eee; padding-bottom: 5px; }}
    ...
    <body>
        <div class="container">
            <h2 class="title">🚀 Daily Tech Briefing</h2>
            <div class="content">
                {html_content}
            </div>
            <div class="footer">
                Generated by Gemini 2.5 Flash Agent
            </div>
        </div>
    </body>
    </html>
